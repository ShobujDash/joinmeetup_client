...
export const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <span className="font-medium text-primary">{shortName}</span>;
    },
  },
  {
  ...
  },
  {
    ...
    header: "Location",
    cell: ({ row }) => (
      <span className="text-muted-foreground">{row.original.eAddress}</span>
    ),
  },
  {
...
export function EventsTable({ data: initialData }) {
