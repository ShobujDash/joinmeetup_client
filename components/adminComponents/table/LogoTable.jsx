...
const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <img
        src={`${process.env.NEXT_PUBLIC_BASE_URI}/${row.original.banner}`}
        alt="Banner"
...
export function LogoTable({ data: initialData }) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <div>
          <h1 className="font-bold text-lg text-blue-700">All Logo</h1>
        </div>
        <div className="flex items-center gap-2">
          ...
          >
            <IconPlus />
            <span className="hidden lg:inline">Add Logo</span>
          </Button>
        </div>
      </div>
      <TabsContent
