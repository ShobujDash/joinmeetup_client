...
import { TicketGenerator } from "../profile/TicketGenerator";
    ...
    cell: ({ row }) => {
      const handleDownload = async () => {
        ...
        try {
          ...
          // filename from event or transactionId
          const fileName =
            ticketData?.event?.eName?.replace(/\s+/g, "_") ||
            ticketData.transactionId;

          link.download = `${fileName}_ticket.pdf`;
...
export function RegisteredEventTable({ data: initialData }) {
